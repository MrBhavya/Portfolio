...
[GitHub](https://github.com/MrBhavya/Leap-Quest)
...
One of the main challenges was coordinating sprite animation and gameplay logic to achieve fluid and reactive character movement. Creating layered tilemaps that maintained both visual richness and efficient collision detection required iterative testing. These challenges led to a deeper understanding of both technical pipelines and collaborative game development.
